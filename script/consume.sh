...
# $KAFKADIR/bin/kafka-console-consumer.sh --zookeeper 167.205.35.25:2181 --topic part --from-beginning
# $KAFKADIR/bin/kafka-console-consumer.sh --zookeeper 167.205.35.25:2181 --topic supplier --from-beginning
# $KAFKADIR/bin/kafka-console-consumer.sh --zookeeper 167.205.35.25:2181 --topic partsupp --from-beginning
