...
-- 1464739200000 = 1 june 2012 00 GMT and 1472688000000 is 1 sep 2012 00 GMT. Choose 3 months instead of 1 year due to the dataset range only 1 year
...
STORE tmp9 INTO 'hdfs://localhost:54310/user/hduser/result9' USING PigStorage(',');
